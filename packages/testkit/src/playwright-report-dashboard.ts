...
<body>
  <main>
    <header>
      <div>
        <p class="eyebrow">Troupe · browser checks</p>
        <h1>Playwright</h1>
      ...
      <div class="actions">
        ...
        <a class="button" href="https://github.com/raktim-mondol/troupe/actions">GitHub Actions</a>
      </div>
    </header>
...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1" />
  <meta name="color-scheme" content="dark" />
  <title>Run screenshots · Troupe</title>
  <style>
    ${SHARED_PAGE_STYLES}
...
<body>
  <main>
    <header>
      <div>
        <p class="eyebrow">Troupe · visual review</p>
  ...
  <script>
    ...
    const storageKey = "troupe-playwright-gallery-columns";
