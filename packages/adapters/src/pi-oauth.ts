...
import type { ModelOAuthBegin, ModelOAuthSignInMode } from "@troupe/contracts";
...
> = {
  [CHATGPT_OAUTH_PROVIDER]: {
    ...
    billing:
      "Sign in with ChatGPT Plus or Pro. Uses your OpenAI subscription. Troupe does not pay.",
  },
  [COPILOT_OAUTH_PROVIDER]: {
    mode: "device-code",
    loginLabel: "Sign in with GitHub Copilot",
    hint: "Copilot",
    billing: "Sign in with GitHub Copilot. Uses your Copilot subscription. Troupe does not pay.",
  },
  [XAI_OAUTH_PROVIDER]: {
    mode: "device-code",
    loginLabel: "Sign in with SuperGrok or X Premium",
    hint: "SuperGrok / key",
    billing: "Sign in with SuperGrok or X Premium, or paste an xAI API key. Troupe does not pay.",
  },
  [ANTHROPIC_OAUTH_PROVIDER]: {
    ...
    billing:
      "Sign in with Claude Pro or Max, or paste an Anthropic API key. Uses your Anthropic subscription. Troupe does not pay.",
  },
};
